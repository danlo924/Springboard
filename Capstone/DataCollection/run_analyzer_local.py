...
class Analyzer:
    ...
    def analyze(self, spark, divs_and_prices):
        ...
        avg_by_ticker_and_days.write.partitionBy("Ticker").parquet("output/returns".format("Ticker"), mode="overwrite") 
        ...
        avg_all_by_days.write.partitionBy("Ticker").parquet("output/returns".format("Ticker"), mode="append") 
        ...
        avg_all_by_weeks.write.partitionBy("Ticker").parquet("output/returns".format("Ticker"), mode="append")         
...
def run_return_by_days_analysis():
    ...
    try:
        ...
        ## GET DIRECTORY
        prices_dir = secrets.get('divs_and_prices_dir')
        ...
        divs_and_prices = spark.read.parquet(prices_dir)
